...
# 工具结果最小化截断：头部/尾部保留字符数（0=自动取阈值 80%/20%）
TOOL_RESULT_TRUNCATE_HEAD = env.int("TOOL_RESULT_TRUNCATE_HEAD", 0)
TOOL_RESULT_TRUNCATE_TAIL = env.int("TOOL_RESULT_TRUNCATE_TAIL", 0)
